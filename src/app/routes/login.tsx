...
const GOOGLE_REDIRECT_URI = import.meta.env.VITE_GOOGLE_REDIRECT_URI ?? 'postmessage'
...
function Login() {
  ...
  const errorMessage = (error as Error | null)?.message ?? 'Đăng nhập thất bại, thử lại nhé!'
      ...
      <div className="flex flex-col items-center justify-center flex-1 px-6 py-16 bg-white">
        <div className="w-full max-w-sm">
          ...
          <div className="mb-8 text-center">
            ...
            <p className="mt-2 text-sm text-muted-foreground">Đăng nhập để sử dụng đầy đủ tính năng</p>
          </div>
          ...
          >
            {isPending ? (
              <InlineLoader text="" className="text-emerald-600" />
            ) : (
              <GoogleIcon />
            )}
